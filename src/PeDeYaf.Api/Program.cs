...
builder.Services.AddDbContext<AppDbContext>(opts =>
    opts.UseInMemoryDatabase("PeDeYafDb"));
...
builder.Services.AddScoped<PeDeYaf.Application.Documents.Commands.IBackgroundJobClient, HangfireJobClient>();
...
app.MapGet("/", () => Results.Ok("PeDeYaf API"));
